                            ...
                            <div class="flex items-center gap-2">
                                ...
                                @if ($item->category)
                                    <span class="text-xs px-2 py-1 rounded border"
                                        style="background-color: {{ $item->category->color }}15; border-color: {{ $item->category->color }}50; color: {{ $item->category->color }};">
                                        {{ $item->category->name }}
                                    </span>
                                @endif
                                ...
                                @php
                                    ...
                                    $isSoon =
                                        !$item->completed_at && !$isOverdue && $item->end_date->lte(now()->addDay());
                                @endphp
